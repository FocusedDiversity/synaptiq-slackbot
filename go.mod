module github.com/synaptiq/standup-bot

go 1.24.4

replace (
	github.com/synaptiq/standup-bot/config => ./config
	github.com/synaptiq/standup-bot/context => ./context
)
...
require (
	...
	github.com/synaptiq/standup-bot/config v0.0.0-00010101000000-000000000000
	github.com/synaptiq/standup-bot/context v0.0.0-00010101000000-000000000000
)
